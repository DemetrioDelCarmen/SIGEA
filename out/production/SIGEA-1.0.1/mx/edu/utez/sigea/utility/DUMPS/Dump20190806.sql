...
begin
	SELECT id_Docente, CONCAT(Nombre_docente," ",PrimerApellido_Docente," ",
    SegundoApellido_Docente) as nombreDocente,
    Nombre_Mat, COUNT(id_asesoriaEstudinate) as asesoriasImpartidas,
	CONCAT(dia_dia,"  ",horaInicio," - ", horaFin) as horario
	FROM
...
-- Dump completed on 2019-08-06 12:55:55
