...
INSERT INTO `hoficial` VALUES (1,1,1,'07:00:00','08:00:00'),(2,1,2,'10:00:00','11:00:00'),(3,2,3,'09:00:00','10:00:00'),(4,2,4,'12:00:00','13:00:00'),(5,3,2,'14:00:00','15:00:00'),(6,3,5,'14:00:00','15:00:00'),(7,8,4,'13:00:00','14:00:00'),(26,15,3,'12:00:00','13:00:00'),(27,9,2,'13:00:00','14:00:00'),(28,9,1,'15:00:00','16:00:00'),(29,5,2,'00:00:03','00:00:09');
...
begin
        ...
        SELECT id_estudiante, CONCAT(Nombre_estudiante, " ",
				PrimerApellido_estudiante," ",
				SegundoApellido_estudiante) as nombre,
				idCarrera, idGenero, usuario FROM estudiante
                r JOIN  usuario u ON 
                usuario_id_User = id_User WHERE u.usuario = matricula;
	end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtenerHoraAsesoria`(in idDoc int, idDia int)
BEGIN
SELECT  CONCAT(horaInicio," - ",horaFin) as hora FROM hoficial WHERE docente_id_Docente = idDoc AND  dia_id_dia = idDia;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-08-15 22:47:20
