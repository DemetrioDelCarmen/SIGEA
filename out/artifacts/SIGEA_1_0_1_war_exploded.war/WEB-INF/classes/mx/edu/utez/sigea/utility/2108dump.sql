...
INSERT INTO `asesoria` VALUES (1,1,3,2,'JavaScript','No tengo lap'),(2,1,3,2,'Javascript','Funciones asincronas'),(3,1,3,2,'Javascript','Funciones asincronas'),(4,1,3,2,'Javascript','Funciones'),(5,1,1,1,'DFR','Objetivos especificos'),(6,1,1,1,'DFR','Objetivos especificos'),(7,1,2,9,'Certificado SSL','InstalaciÃ³n'),(8,1,2,9,'Certificado SSL','InstalaciÃ³n');
...
INSERT INTO `asesoriaestudiante` VALUES (1,1,1,1,1),(2,1,1,1,1),(3,2,1,0,2),(4,4,1,0,2),(5,5,1,0,1),(6,6,1,0,2),(7,7,1,0,1),(8,8,1,0,2);
...
INSERT INTO `asesoriahoficial` VALUES (1,1,3),(2,2,3),(3,4,3),(4,5,1),(5,6,1),(6,7,27),(7,8,27);
...
INSERT INTO `docentes_materias` VALUES (1,1,1),(2,2,3),(3,3,4),(4,4,12),(5,5,13),(6,5,3),(7,5,15),(8,5,16),(9,6,3),(10,23,17),(11,23,3),(12,7,13),(13,8,11),(14,8,2),(15,8,18),(16,8,1),(18,10,19),(19,11,20),(20,11,21),(21,12,11),(22,13,22),(23,13,23),(24,14,24),(25,14,25),(26,15,26),(27,16,27),(28,17,22),(29,18,28),(30,19,29),(31,19,1),(32,20,30),(33,21,31),(34,9,2);
...
INSERT INTO `estudiantegrupo` VALUES (1,1,1),(2,2,1),(3,3,1),(4,4,1);
...
INSERT INTO `hoficial` VALUES (1,1,1,'07:00:00','08:00:00'),(2,1,2,'10:00:00','11:00:00'),(3,2,3,'09:00:00','10:00:00'),(4,2,4,'12:00:00','13:00:00'),(5,3,2,'14:00:00','15:00:00'),(6,3,5,'14:00:00','15:00:00'),(7,8,4,'13:00:00','14:00:00'),(26,15,3,'12:00:00','13:00:00'),(27,9,2,'13:00:00','14:00:00'),(28,9,1,'15:00:00','16:00:00'),(29,5,2,'00:00:03','00:00:09'),(30,3,3,'13:00:00','14:00:00');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `loadStudentById` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `loadStudentById`(in idEstudiante int)
begin
SELECT e.id_estudiante, idCarrera, idGenero, 
				egp.grupo_id_grupo as grupo FROM estudiante 
                e JOIN  usuario u ON 
                usuario_id_User = id_User 
                JOIN estudiantegrupo egp
                ON egp.id_estudianteGrupo = e.id_estudiante
...
/*!50003 DROP PROCEDURE IF EXISTS `loadUserByID` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `loadUserByID`(in idEstudent INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_consultarDiasDocente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consultarDiasDocente`(in idDoc int)
begin
SELECT id_dia as idDia, dia_dia as dia FROM docente  dc JOIN
		hoficial hof ON dc.id_Docente = hof.docente_id_docente
        JOIN dia ON hof.dia_id_dia  = id_dia WHERE dc.id_Docente = idDoc;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_docentesGenerales` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_docentesGenerales`()
begin
			SELECT dc.id_Docente, CONCAT(Nombre_docente," ",PrimerApellido_Docente," ",
			SegundoApellido_Docente) as nombreDocente, mt.Nombre_Mat materia FROM docente dc
			JOIN docentes_materias dcm ON dcm.id_Docente = dc.id_Docente
			JOIN  materia mt ON dcm.id_Mat = mt.id_Mat
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insertarHorario`(in idDocente int, in idDia int, in hInicial time, in hFinal time)
begin
		INSERT INTO hoficial (docente_id_Docente, dia_id_dia,horaInicio,horaFin)
		VALUES (idDocente,idDia,hInicial,hFinal);
 end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
begin
	SELECT dc.id_Docente, CONCAT(Nombre_docente," ",PrimerApellido_Docente," ",
    SegundoApellido_Docente) as nombreDocente, mt.Nombre_Mat,dia_dia as dia, CONCAT(hof.horaInicio, " - ",hof.horaFin) as  horario FROM docente dc
    JOIN docentes_materias dcm ON dcm.id_Docente = dc.id_Docente
    JOIN  materia mt ON dcm.id_Mat = mt.id_Mat
    JOIN hoficial hof ON dc.id_Docente = hof.docente_id_Docente
    JOIN dia  ON hof.dia_id_dia = dia.id_dia
    ORDER BY Nombre_docente;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_listarAsesoriasRegistradas` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listarAsesoriasRegistradas`(in usuarioP VARCHAR(20))
BEGIN
SELECT * FROM (SELECT  mat.Nombre_mat as materia, dia.dia_dia as dia,CONCAT(hof.horaInicio," - ",hof.horaFin) as hora, CONCAT(dc.Nombre_docente," ",dc.PrimerApellido_Docente," ",dc.SegundoApellido_Docente) as nombreDocente,
 ase.Comentario_asesoria as comentario, sta.status_asesoria as estado, GROUP_CONCAT(u.usuario) as participantes FROM asesoria ase JOIN  docente dc 
ON ase.docente_id_docente = dc.id_Docente JOIN status_asesoria sta ON ase.Status_asesorias  = sta.id_status_asesoria JOIN asesoriaestudiante ae
ON ase.id_asesorias = ae.id_asesoria JOIN estudiante est ON ae.idEstudiante = est.id_estudiante JOIN usuario u 
ON est.usuario_id_User = u.id_User JOIN asesoriahoficial ash ON ase.id_asesorias = ash.asesoria_id_asesorias JOIN
hoficial hof ON ash.id_asesoriaHOficial = hof.id_HOficial JOIN materia mat ON ase.materia_id_mat = mat.id_Mat JOIN dia ON hof.dia_id_dia = dia.id_dia WHERE sta.id_status_asesoria IN (1,4) group by ase.id_asesorias ) as sub WHERE participantes LIKE CONCAT('%',usuarioP,'%');
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_loadStudentByMatricula` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_loadStudentByMatricula`(in matricula varchar(30))
begin
        
 SELECT e.id_estudiante, CONCAT(Nombre_estudiante, " ",
				PrimerApellido_estudiante," ",
				SegundoApellido_estudiante) as nombre,
				idCarrera, idGenero,usuario, egp.grupo_id_grupo as grupo FROM estudiante 
                e JOIN  usuario u ON 
                usuario_id_User = id_User 
                JOIN estudiantegrupo egp
                ON egp.id_estudianteGrupo = e.id_estudiante
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_obtenerHoraAsesoria` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_obtenerHoraAsesoria`(in idDoc int)
BEGIN
SELECT id_HOficial, CONCAT(dia_dia, " - ",horaInicio," - ",horaFin) as horario FROM hoficial  JOIN dia  ON hoficial.dia_id_dia = id_dia WHERE docente_id_Docente = idDoc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_registrarAsesoria` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_registrarAsesoria`(IN statusAsesoria INT(1), IN idMateria INT(3), IN idDocente INT(4), IN tema VARCHAR(30),
 IN comentario VARCHAR(50),IN idHoficial INT(4),IN idGrupo INT(2), IN asistio INT(1),IN estudianteId INT(10))
begin
	DECLARE idAse INT;
	INSERT INTO asesoria (Status_asesorias,materia_id_mat,docente_id_docente,Tema_asesoria,Comentario_asesoria) VALUES(statusAsesoria,idMateria,idDocente,tema,comentario);
	SELECT last_insert_id() INTO idAse;
    INSERT INTO asesoriahoficial(asesoria_id_asesorias,HOficial_id_HOficial) VALUES(idAse,idHoficial);
    INSERT INTO asesoriaestudiante(id_asesoria,idEstudianteGrupo,Asistio_asesoria,idEstudiante) VALUES(idAse,idGrupo,asistio,estudianteId);
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-08-21 21:16:32
